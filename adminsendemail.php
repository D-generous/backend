...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM `adminusers` WHERE email = '$to'";
    ...
    if ($con->num_rows>0) {
        ...
        $insertTokenQuery = "UPDATE `adminusers` SET reset_token='$token', token_expiry='$expiry_time' WHERE email='$to'";
        ...
        try {
            ...
            $resetLink = "https://election-rouge.vercel.app/adminpasswordreset/?token=$token";
            $mail->Body    = "
                <p>Hi, $fullname</p>
